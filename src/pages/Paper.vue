<template>
  <div>
    <div class="checklist">
      <p class="tips">为进一步提高工会会员对节日慰问品福利的满意度，给会员提供更多的选择，2019年度“五一”节日慰问品将采取A、B套餐的发放形式，请每位会员任意选择下方A、B套餐其中之一提交，选择提交后不得更换，公司工会将根据选择数量进行备货并发放。</p>
      <p class="tips">套餐选择起止时间:2019年4月24日——4月25日24点。</p>

<template>
  <div>
    <div class="checklist">
      <p class="tips">根据公司工会会员生日蛋糕券采购合同条款约定，现对元祖食品有限公司提供的2018年生日蛋糕进行年度评审，若同意续签人数超过不同意续签人数，则继续沿用元祖食品有限公司提供2019年工会会员生日蛋糕券，否则，不与元祖食品有限公司续签合同，并另行开展2019年工会会员生日蛋糕券招标采购工作。请工会会员从价格、种类、口感、服务等方面对其进行评价，并投上您宝贵的一票！</p>
